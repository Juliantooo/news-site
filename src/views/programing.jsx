import { PROGRAMMING_NEWS } from "../service/api_path"
...
const Programing = () => {
    const { newsData, headlineNews } = NewsHooks({ method: 'get', url: PROGRAMMING_NEWS });
    ...
    return (
        <div>
            <h1 className="mx-2 text-2xl font-bold my-5">Berita Programming News</h1>
            <hr className="mx-2 " />
