...
const NewsSideCard = ({image,title,category}) => {
    return (
        <div className="w-full p-2 flex flex-row lg:flex-col space-x-2 lg:space-x-0 justify-between  bg-gray-800 bg-opacity-20 cursor-pointer hover:bg-opacity-50">
