  ...
  const handleClick = () =>{
    ...
    return (
        <nav className="h-screen w-full bg-gray-800 text-white space-y-10 px-5 font-semibold flex flex-col z-20 fixed top-0">
          ...
          <Link onClick={onSidebarToogle} to="/indonesia">Indonesia</Link>
          <Link onClick={onSidebarToogle} to="/programing">Programing</Link>
          <Link onClick={onSidebarToogle} to="/covid">Covid</Link>
          <Link onClick={onSidebarToogle} to="/saved">Saved</Link>
        </nav>
    )
}
